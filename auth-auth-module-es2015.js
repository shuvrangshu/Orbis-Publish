...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 40, vars: 0, consts: [["fxLayout", "column"], ["fxFlex", ""], ["fxFlex", "65%"], ["fxFlex", "100%", "fxFlexAlign", "center", 1, "login-title"], ["fxFlex", "100%", "fxFlexAlign", "center", 1, "login-banner-img"], ["src", "../../../assets/login_bg1.png"], [1, "bannner-title"], [1, "bannner-title-small"], ["fxFlex", "35%"], [1, "login-area"], [1, "login-area-heading"], [1, "login-area-heading-sub"], [1, "login-text-placeholder"], [1, "login-text-lable"], [1, "login-text"], ["type", "text"], ["type", "password"], [1, "login-btn-area"], ["mat-raised-button", "", "color", "primary", 3, "click"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginComponent_Template_button_click_38_listener() { return ctx.onSignIn(); });
